...
class Dz11StudentEditFragment : Fragment(), Dz11StudentEditView {
    ...
    private lateinit var editPresenter: Dz11EditPresenter
    ...
    companion object {
        val TAG = Dz11StudentEditFragment::class.java.canonicalName!!

        fun getInstance(id: String? = null): Dz11StudentEditFragment {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        editPresenter = Dz11StudentEditPresenter()

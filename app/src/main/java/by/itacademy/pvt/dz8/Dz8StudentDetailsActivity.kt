...
class Dz8StudentDetailsActivity : Activity() {
    ...
    companion object {
        fun getIntent(context: Context, id: String = ""): Intent {
            val intent = Intent(context, Dz8StudentEditActivity::class.java)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_dz8_student_details)
        ...
        if (student != null) {
            loadCircleImage(this@Dz8StudentDetailsActivity, student.imageUrl, avatarImageView)
    ...
    private fun startEditActivity(id: String = "") {
        val intent = Intent(this, Dz8StudentEditActivity::class.java)
        intent.putExtra(STUDENT_ID, id)
